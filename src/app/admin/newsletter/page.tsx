          ...
          <div className="bg-zinc-800/50 border border-zinc-700 rounded-xl p-8 shadow-xl">
            <div className="flex flex-col items-center justify-center text-center py-12">
              ...
              <p className="text-gray-400 max-w-md mb-8">
                Esta acción generará y enviará el correo con los 3 eventos más
                destacados a todos los usuarios suscritos actualmente.
              </p>
                ...
                className={`
                                    ...
                                    ${
                                      loading
                                        ...
                                        : "bg-linear-to-r from-purple-600 to-pink-600 text-white hover:scale-105 shadow-lg hover:shadow-purple-500/25"
                                    }
                                `}
              >
                {loading ? (
